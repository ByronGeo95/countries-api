...
import { faGlobe, faGlobeEurope, faQuestionCircle } from '@fortawesome/free-solid-svg-icons';
...
const Europe = (props) => (
    <Layout>
        <div>
            ...
            <hr style={{ backgroundColor: 'black', padding: '0.75px', marginTop: 0, marginBottom: 0 }} ></hr>
            <h3 style={{ marginBottom: 0 }} > <FontAwesomeIcon icon={faGlobeEurope} /> EUROPE : {props.europeData.length}</h3>
            <hr style={{ backgroundColor: 'black', padding: '0.75px', marginTop: 0, marginBottom: 0 }} ></hr>
...
//     const result = await fetch('https://restcountries.com/v2/region/europe');
...
//https://restcountries.eu/rest/v2/region/europe (old)
//https://restcountries.com/v2/region/europe (new)